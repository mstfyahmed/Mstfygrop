...
Coded by a kid- github.com/mstfyahmed/Mstfygrop
...
def banner():
    ...
    print(f'{lg}Version: {w}2.0{lg} | GitHub: {w}@mstfyahmed{n}')
...
def send_message_all_accounts():
    ...
    promotional_message = "This message was sent using mass DM tool GitHub.com/mstfyahmed/Mstfygrop"
