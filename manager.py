...
def banner():
    ...
    print(f'{lg}Version: {w}2.6.82{lg} | GitHub: {w}@mstfyahmed{n}')
    print(f'{lg}Telegram: {w}@Mstfymstfy{lg} | Channel: {w}https://t.me/Next_Plus_BOT0{n}')
...
def update_script():
    ...
    try:
        version = requests.get('https://raw.githubusercontent.com/mstfyahmed/Mstfygrop/main/version.txt')
    except:
    ...
    if float(version.text) > 2.0:
        ...
        if prompt in {'y', 'yes', 'Y'}:
            ...
            os.system('curl -l -O https://raw.githubusercontent.com/mstfyahmed/Mstfygrop/main/add.py')
            os.system('curl -l -O https://raw.githubusercontent.com/mstfyahmed/Mstfygrop/main/manager.py')
